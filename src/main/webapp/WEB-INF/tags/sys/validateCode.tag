...
<input type="text" id="${name}" name="${name}" maxlength="4" class="txt required" style="font-weight:bold;width:45px;${inputCssStyle}"/>
...
<a href="javascript:" onclick="$('.${name}').attr('src','${pageContext.request.contextPath}/servlet/validateCodeServlet?'+new Date().getTime());" class="mid ${name}Refresh" style="${buttonCssStyle};color:#ceb91d">看不清</a>